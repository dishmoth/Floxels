...
class OggDecode {
  ...
  public static Clip toClip(InputStream input) throws IOException {
    ...
    // construct a Clip
    return newClip(info.rate, info.channels, outStream.toByteArray());
    
  } // toClip()
    
  // read the input stream as Ogg Vorbis data, and return a SoundEffect object
  public static SoundEffect toSoundEffect(InputStream input) 
                                         throws IOException {
    ...
    // construct a SoundEffect
    return newSoundEffect(info.rate, info.channels, outStream.toByteArray());
